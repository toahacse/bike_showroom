...
<div class="invoice">
    <table width="100%">
        <tr>
            ...
            <td>
                <p style="text-align: right; margin-right: 10px">Date: {{ $buy->date }}</p>
            </td>
        </tr>
    </table>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><p style="text-align: center">{{$buy->bike_no}}</p></td>
            <td><p style="text-align: center">1</p></td>
            <td><p style="text-align: center">{{$buy->price}} TK</p></td>
        </tr>
        <tr>
            <td colspan="4">
                <p style="float: right; margin-right: 20px; padding-top: 10px" >Total: {{$buy->price}} TK</p>
            </td>
        </tr>
    </table>
</div>
