...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a style="font-size: 22px;" class="navbar-brand" href="{{asset('/buy_bike')}}">Modhina Motors(Document Entry Admin)</a>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    {{--<li style="font-size: 18px">--}}
                        {{--<a href="{{asset('/document_entry')}}"><i class="fa fa-home fa-fw"></i> Home</a>--}}
                    {{--</li><br>--}}
                    <li style="font-size: 18px">
                        <a href="{{asset('/buy_bike')}}"><i class="fa fa-motorcycle fa-fw"></i> Buy Bike</a>
                    </li><br>
